  ...
  const toolCategories = [
    {
      ...
      tools: [
        { id: 'docs', label: 'Documents', icon: FileText, color: 'text-blue-500', bg: 'bg-blue-500/10', desc: 'Professional authoring & drafting' },
        { id: 'sheets', label: 'Spreadsheets', icon: Table, color: 'text-emerald-500', bg: 'bg-emerald-500/10', desc: 'Data modeling & spreadsheets' },
        { id: 'slides', label: 'Presentations', icon: Presentation, color: 'text-amber-500', bg: 'bg-amber-500/10', desc: 'Visual storytelling & decks' },
        { id: 'pdf-editor', label: 'PDF Editor', icon: FileEdit, color: 'text-red-500', bg: 'bg-red-500/10', desc: 'Advanced document manipulation' },
        { id: 'calendar', label: 'Calendar', icon: Calendar, color: 'text-rose-500', bg: 'bg-rose-500/10', desc: 'Universal time orchestration' },
        { id: 'file-manager', label: 'Archive', icon: FolderCheck, color: 'text-slate-600', bg: 'bg-slate-600/10', desc: 'Neural file system explorer' },
        { id: 'work-log', label: 'Timesheets', icon: Clock, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'Precision billable tracking' },
        { id: 'calculator', label: 'Calculator', icon: Calculator, color: 'text-slate-600', bg: 'bg-slate-600/10', desc: 'Advanced financial logic' },
        { id: 'password-safe', label: 'Security', icon: ShieldAlert, color: 'text-slate-900', bg: 'bg-slate-900/10', desc: 'Encrypted credential vault' },
        { id: 'notes', label: 'Notes', icon: StickyNote, color: 'text-purple-500', bg: 'bg-purple-500/10', desc: 'Rapid ideation & capture' },
        { id: 'journal', label: 'Journal', icon: Book, color: 'text-indigo-400', bg: 'bg-indigo-400/10', desc: 'Executive reflection log' },
        { id: 'timer', label: 'Timer', icon: TimerIcon, color: 'text-amber-500', bg: 'bg-amber-500/10', desc: 'Focused focus intervals' },
        { id: 'deadline-countdown', label: 'Deadlines', icon: AlarmClock, color: 'text-rose-600', bg: 'bg-rose-600/10', desc: 'Precision target tracking' },
        { id: 'time-zone-converter', label: 'World Clocks', icon: Map, color: 'text-blue-500', bg: 'bg-blue-500/10', desc: 'Global sync logic' },
        { id: 'follow-up-scheduler', label: 'Follow-Ups', icon: CalendarClock, color: 'text-emerald-500', bg: 'bg-emerald-500/10', desc: 'Persistence automation logic' }]
    },
    {
      name: "Strategic Enterprise",
      tools: [
        { id: 'ledger', label: 'Finance', icon: Wallet, color: 'text-emerald-500', bg: 'bg-emerald-500/10', desc: 'Double-entry ledger systems' },
        { id: 'invoice-generator', label: 'Billing', icon: Receipt, color: 'text-emerald-600', bg: 'bg-emerald-600/10', desc: 'Automated invoice generation' },
        { id: 'plan-builder', label: 'Business Plan', icon: Briefcase, color: 'text-blue-600', bg: 'bg-blue-600/10', desc: 'Comprehensive business planning' },
        { id: 'roadmap-planner', label: 'Roadmap', icon: Map, color: 'text-orange-500', bg: 'bg-orange-500/10', desc: 'High-level strategic forecasting' },
        { id: 'decision-log', label: 'Rational', icon: BrainCircuit, color: 'text-violet-500', bg: 'bg-violet-500/10', desc: 'Strategic decision audit logs' },
        { id: 'quote-generator', label: 'Estimates', icon: ScrollText, color: 'text-amber-500', bg: 'bg-amber-500/10', desc: 'Project scoping & quotes' },
        { id: 'e-signature', label: 'Signify', icon: FileSignature, color: 'text-blue-500', bg: 'bg-blue-500/10', desc: 'Secure electronic signature' },
        { id: 'sop-creator', label: 'Ops', icon: ClipboardList, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'Standard operating procedures' },
        { id: 'internal-wiki', label: 'Knowledge', icon: Library, color: 'text-amber-600', bg: 'bg-amber-600/10', desc: 'Distributed team brain' },
        { id: 'quiz-creator', label: 'Assess', icon: HelpCircle, color: 'text-amber-500', bg: 'bg-amber-500/10', desc: 'Knowledge audit synthesis' },
        { id: 'meeting-recorder', label: 'Briefings', icon: Radio, color: 'text-rose-500', bg: 'bg-rose-500/10', desc: 'Strategic session recording' },
        { id: 'domain-portfolio', label: 'Assets', icon: Globe, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'Digital real-estate tracker' },
        { id: 'project-manager', label: 'Kanban', icon: LayoutList, color: 'text-cyan-500', bg: 'bg-cyan-500/10', desc: 'Project orchestration suite' }]
    },
    {
      name: "Growth & Marketing",
      tools: [
        { id: 'content-calendar', label: 'Strategy', icon: CalendarDays, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'Multi-channel social planning' },
        { id: 'client-vault', label: 'CRM', icon: Users, color: 'text-cyan-500', bg: 'bg-cyan-500/10', desc: 'Relationship orchestration' },
        { id: 'sales-script-library', label: 'Playbooks', icon: MessageSquare, color: 'text-blue-500', bg: 'bg-blue-500/10', desc: 'High-conversion sales scripts' },
        { id: 'ai-pricing-strategist', label: 'Pricing', icon: CreditCard, color: 'text-emerald-600', bg: 'bg-emerald-600/10', desc: 'Optimal monetization modeling' },
        ]
    },
    
    {
      ...
      tools: [
        { id: 'canvas', label: 'Brainstorm', icon: PenTool, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'Creative canvas & ideation' },
        { id: 'ai-collaborative-whiteboard', label: 'Whiteboard', icon: MousePointer2, color: 'text-violet-500', bg: 'bg-violet-500/10', desc: 'Real-time neural collab' },
        { id: 'mockup-studio', label: 'Mockups', icon: MonitorSmartphone, color: 'text-indigo-500', bg: 'bg-indigo-500/10', desc: 'High-fidelity product visuals' },
        { id: 'stock-media', label: 'Vault', icon: Image, color: 'text-emerald-600', bg: 'bg-emerald-600/10', desc: 'Curated visual assets' },
        { id: 'video-script-specialist', label: 'Scripts', icon: FileText, color: 'text-rose-500', bg: 'bg-rose-500/10', desc: 'Visual narrative logic' }]
    },
    {
      name: "Engineering & Dev",
      tools: [
        { id: 'chart-maker', label: 'Visuals', icon: BarChart3, color: 'text-emerald-500', bg: 'bg-emerald-500/10', desc: 'Complex visual data modeling' },
        ]
    },
    {
      name: "Strategic Logic & Legal",
      tools: [
        { id: 'ai-trademark-scout', label: 'Trademark', icon: Stamp, color: 'text-amber-600', bg: 'bg-amber-600/10', desc: 'Brand security intelligence' },
        ]
    },
